...
db.cuadros.insertMany([
    {_id: 1, 
        ...
        ubicacion: "Museo del Louvre",
        colores: ["negro", "café","ocre","verde"],
        cantidad: 1,
...
db.pedidos.insertMany([
    ...
    {_id: 4, producto: "Autorretrato", cantidad: 1, precio: 270000000, ciudad: "Bilbao", fechaPedido: new Date("2021,07,29"), fechaEntrega: new Date("2021,11,03"), retraso: false},
    ...
    {_id: 11, producto: "Las señoritas de Avignon", cantidad: 2, precio: 2800000, ciudad: "Murcia", fechaPedido: new Date("2021,10,16"), fechaEntrega: new Date("2021,11,11"), retraso: true},
    {_id: 12, producto: "El viejo guitarrista ciego", cantidad: 1, precio: 250000, ciudad: "Cuenca", fechaPedido: new Date("2021,08,12"), fechaEntrega: new Date("2021,09,12"), retraso: false},
    {_id: 13, producto: "Nighthawks", cantidad: 3, precio: 86000, ciudad: "Badajoz", fechaPedido: new Date("2021,06,16"), fechaEntrega: new Date("2021,10,30"), retraso: true},
    ...
    {_id: 15, producto: "La noche estrellada", cantidad: 6, precio: 66000000, ciudad: "Salamanca", fechaPedido: new Date("2021,02,23"), fechaEntrega: new Date("2021,07,23"), retraso: true},
